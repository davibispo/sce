        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <a href="{{route('participantes.show', $evento->id)}}" class="btn btn-default btn-xs" role="button">
                        <i class="fa fa-chevron-left" aria-hidden="true"></i> Voltar
                    </a>
                </div>

                <div class="panel-body">
                    {!! Form::open(['class'=>'form-horizontal', 'name'=>'MainForm', 'method'=>'POST', 'action'=>['ParticipanteController@storeParticipanteIndividual',$evento->id]]) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            {!! Form::text('endereco_num', null, ['class'=>'form-control', 'placeholder'=>'Digite o número..', 'required']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            {!! Form::text('cpf', null, ['class'=>'form-control', 'placeholder'=>'Digite somente números..', 'required']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-4">
                            {!! Form::submit('Adicionar Funcionario Participante', ['class'=>'btn btn-primary']) !!}
                        </div>
                    </div>
